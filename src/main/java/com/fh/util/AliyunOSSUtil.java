...
public class AliyunOSSUtil {
    ...
    private final static String ACCESS_KEY_ID = "LTAI4Fc7GTS7Ctvmb77LuHw2";
    private final static String ACCESS_KEY_SECRET = "FarK0E2GCVvpleY9HqNik0ZMbv89rL";
    private final static String BUCKET_NAME = "it-fh";
    private final static String BUCKET_URL = "https://it-fh.oss-cn-beijing.aliyuncs.com";
